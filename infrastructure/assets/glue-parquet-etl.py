...
DataSource0 = glueContext.create_dynamic_frame.from_catalog(
    database=glue_db, table_name=glue_hiring_table, transformation_ctx="DataSource0"
)

DataSource1 = glueContext.create_dynamic_frame.from_catalog(
    database=glue_db, table_name=glue_covid_table, transformation_ctx="DataSource1"
)

# Join Covid case data with hiring data
Transform0 = Join.apply(
    frame1=DataSource1,
    frame2=DataSource0,
    keys2=["post_date"],
    keys1=["date"],
...
Transform1 = ApplyMapping.apply(
    ...
    mappings=[
        ...
        ("icu_patients", "string", "icu_patients", "string"),
        ("icu_patients_per_million", "string", "icu_patients_per_million", "string"),
        ("hosp_patients", "string", "hosp_patients", "string"),
        ("hosp_patients_per_million", "string", "hosp_patients_per_million", "string"),
        ("weekly_icu_admissions", "string", "weekly_icu_admissions", "string"),
        (
        ...
        ("weekly_hosp_admissions", "string", "weekly_hosp_admissions", "string"),
        (
        ...
        ("new_tests", "string", "new_tests", "string"),
        ("total_tests", "string", "total_tests", "string"),
        ("total_tests_per_thousand", "string", "total_tests_per_thousand", "string"),
        ("new_tests_per_thousand", "string", "new_tests_per_thousand", "string"),
        ("new_tests_smoothed", "string", "new_tests_smoothed", "string"),
        (
        ...
        ("positive_rate", "string", "positive_rate", "string"),
        ("tests_per_case", "string", "tests_per_case", "string"),
        ("tests_units", "string", "tests_units", "string"),
        ("total_vaccinations", "double", "total_vaccinations", "double"),
        ("people_vaccinated", "double", "people_vaccinated", "double"),
        ("people_fully_vaccinated", "double", "people_fully_vaccinated", "double"),
        ("total_boosters", "string", "total_boosters", "string"),
        ("new_vaccinations", "double", "new_vaccinations", "double"),
        ("new_vaccinations_smoothed", "double", "new_vaccinations_smoothed", "double"),
        (
        ...
        ("extreme_poverty", "string", "extreme_poverty", "string"),
        ("cardiovasc_death_rate", "double", "cardiovasc_death_rate", "double"),
        ("diabetes_prevalence", "double", "diabetes_prevalence", "double"),
        ("female_smokers", "string", "female_smokers", "string"),
        ("male_smokers", "string", "male_smokers", "string"),
        ...
        ("excess_mortality", "string", "excess_mortality", "string"),
        ("post_date", "string", "post_date", "string"),
        ("count_id_indexed", "double", "count_id_indexed", "double"),
    ],
    transformation_ctx="Transform1",
)

# Filter only on data in USA
Transform2 = Filter.apply(
    frame=Transform1,
    f=lambda x: x["iso_code"] in ["USA"],
...
DataSink0 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    format="glueparquet",
    connection_options={"path": "s3://" + bucket + parquet_prefix, "partitionKeys": []},
