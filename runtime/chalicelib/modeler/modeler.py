...
LogicalTable = namedtuple(
    "LogicalTable",
    "name localized id_type inverse_fks valid_type internal historized pk attributes".split(),
)
LogicalColumn = namedtuple(
    "LogicalColumn", "name localized valid_type type serial_type nullable fk unique pk".split()
)
